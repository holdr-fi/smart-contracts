...
export const deploySingleRecipientGaugeFactory = async function deploySingleRecipientGaugeFactory(
  tokenMinterDeploymentAddress: string,
  force = false
): Promise<ContractDeployment> {
  const contractName = 'SingleRecipientGaugeFactory';
  const constructorArgs = [tokenMinterDeploymentAddress];
