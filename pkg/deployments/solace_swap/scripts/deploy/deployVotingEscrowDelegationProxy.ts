...
export const deployVotingEscrowDelegationProxy = async function deployVotingEscrowDelegationProxy(
  vaultDeploymentAddress: string,
  votingEscrowDeploymentAddress: string,
  votingEscrowDelegationDeploymentAddress: string,
  force = false
): Promise<ContractDeployment> {
  const contractName = 'VotingEscrowDelegationProxy';
  const constructorArgs = [
    vaultDeploymentAddress,
    votingEscrowDeploymentAddress,
    votingEscrowDelegationDeploymentAddress,
  ];
