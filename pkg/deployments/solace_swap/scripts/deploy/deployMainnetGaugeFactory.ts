...
export const deployMainnetGaugeFactory = async function deployMainnetGaugeFactory(
  mainnetGaugeDeploymentAddress: string,
  force = false
): Promise<ContractDeployment> {
  const contractName = 'LiquidityGaugeFactory';
  const constructorArgs = [mainnetGaugeDeploymentAddress];
